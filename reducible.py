...
On my/our honor, Leonardo Robles-Lara, this
...
def step_size(s):
    ...
    """
    double_hashing = hash_word(s, STEP_SIZE_CONSTANT)
    return STEP_SIZE_CONSTANT - (double_hashing % STEP_SIZE_CONSTANT)
...
def is_reducible(s, hash_table, hash_memo):
    ...
    for i, char in enumerate(s):
        sub = ""
        for j, sub_char in enumerate(s):
            if i != j:  
                sub += sub_char
        if find_word(sub, hash_table):
...
def main():
    ...
    words = [line.strip() for line in inputs]
    ...
    longest_reducible_words = sorted(get_longest_words(reducible_words))
